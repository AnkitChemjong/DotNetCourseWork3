...
import { FaThLarge, FaClipboardList, FaSignOutAlt } from 'react-icons/fa';
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-4 border-b">
        <span className="text-xl font-bold text-indigo-600">Staff Panel</span>
      ...
      <div 
        ...
        className='flex items-center gap-2 text-indigo-700 cursor-pointer w-full p-4 rounded-b-lg hover:bg-indigo-50 hover:text-indigo-600'
      >
